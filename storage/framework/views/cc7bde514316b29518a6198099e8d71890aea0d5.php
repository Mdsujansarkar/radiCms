<?php $__env->startSection('meta'); ?>
  ...
  <title><?php echo e(__('দেলোয়ার হোসেন ফারুক')); ?></title>
...
<section class="section-slider">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-4">
           <div class="agent-avatar-boxs">
                <img src="<?php echo e(asset('frontend/assets/img/dhfaruk.jpeg')); ?>" alt="" class="agent-avatar img-fluid">
				
             </div> 
			<div class="text-cpation"> <h3><?php echo e(__('তথ্যপ্রযুক্তি উদ্যোক্তা, পরামর্শক, সমাজকর্মী ও রাজনীতিবিদ')); ?></h3> </div>			 
        </div>
  ...
  <div class="intro intro-carousel">
    <div id="carousel" class="owl-carousel owl-theme">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/8304.jpg')); ?>)">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/8469.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/2494.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/1610.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/5155.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/8496.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/1489.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/5149.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/4933.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/7489.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/2423.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/6611.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/5956.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/7772.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/4900.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/4835.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/6181.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo e(asset('frontend/assets/images/slider/7719.jpg')); ?>)">
        <!-- <div class="overlay overlay-a"></div> -->
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="silder-fotter">
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="agent-avatar-box">
                <img src="<?php echo e(asset('frontend/assets/img/about-image.jpg')); ?>" alt="" class="agent-avatar img-fluid">
              </div>
            </div>
...
<div class="col-md-3">
  <div class="card-box-c foo">
	...
	<div class="card-body-c">
	 <a href="https://youtu.be/8N15qbytPx0" target="_blank"><img src="https://img.youtube.com/vi/8N15qbytPx0/0.jpg" alt="(১৪/৪/২০২০) করোনাভাইরাস (COVID-19) এর সর্বশেষ পরিস্থিতি নিয়..." class="img-fluid"></a>
	   <p class="content-t">
			<?php echo e('(১৪/৪/২০২০) করোনাভাইরাস (COVID-19) এর সর্বশেষ পরিস্থিতি নিয়...'); ?>
  ...
  <section class="section-news section-t8">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            <div class="title-box">
              <h2 class="title-a"><?php echo e('সম্প্রতিক ঘটনা প্রবাহ'); ?></h2>
            </div>
          </div>
        </div>
      </div>
	  ...
	  <div class="col-md-3">
	    <div  class="right-1">
			<div class="img-blog-box-b">
				<img src="<?php echo e(asset('frontend/assets/images/politicalnews/1322.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
			</div>
			<div class="blog-body">                
				<div class="blog-header">
		...
		<div  class="right-2">
			<div class="img-blog-box-b">
				<img src="<?php echo e(asset('frontend/assets/images/politicalnews/5344.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
			</div>
			<div class="blog-body">                
				<div class="blog-header">
					<h5 class="blog-title-right">
  ...
  <!--/ News End /-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oem/Documents/radiCms/resources/views/frontend/home/home.blade.php ENDPATH**/ ?>