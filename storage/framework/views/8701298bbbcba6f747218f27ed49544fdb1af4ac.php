<?php $__env->startSection('meta'); ?>
  ...
  <title><?php echo e(__('কৃতিত্ব | দেলোয়ার হোসেন ফারুক')); ?></title>
...
<style>
      ...
      <section class="news-grid grid">
        <div class="container">
          ...
          <div class="col-md-3">
            ...
            <div class="left-1">
                <div class="img-blog-box-b">
                    <img src="<?php echo e(asset('frontend/assets/images/politicalnews/5874.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
                </div>
                <div class="blog-body">                
          ...
          <div class="col-md-6">
                ...
                <div class="img-blog-box-b">
                    <img src="<?php echo e(asset('frontend/assets/images/politicalnews/8095.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
                </div>
                <div class="blog-body">                
                    <div class="blog-header">
                        <h3 class="blog-title">
          ...
          <div class="col-md-3">
            ...
            <div  class="right-1">
                <div class="img-blog-box-b">
                    <img src="<?php echo e(asset('frontend/assets/images/politicalnews/9660.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
                </div>
                <div class="blog-body">                
                    <div class="blog-header">
            ...
            <div  class="right-2">
                <div class="img-blog-box-b">
                    <img src="<?php echo e(asset('frontend/assets/images/politicalnews/1664.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
                </div>
                <div class="blog-body">                
                    <div class="blog-header">
                        <h5 class="blog-title-right">
           ...
           <div class="col-md-4">
           <div class="img-blog-box-b">
                    <img src="<?php echo e(asset('frontend/assets/images/politicalnews/9843.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
                </div>
                <div class="blog-body">                
                    <div class="blog-header">
                        <h5 class="blog-title-right">
            ...
            <div class="col-md-4">
             ...
             <div class="img-blog-box-b">
                    <img src="<?php echo e(asset('frontend/assets/images/politicalnews/4772.jpg')); ?>" alt="" class="img-b img-fluid img-responsive">
                </div>
                <div class="blog-body">                
                    <div class="blog-header">
                        <h5 class="blog-title-right">
                            <a href="political-single (9).html" >
                                            <?php echo e(__('তথ্য-প্রযুক্তি সমৃদ্ধ উন্নত লাকসাম পৌরসভা গড়াই লক্ষ্য')); ?>
  ...
  <!--/ News End /-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oem/Documents/radiCms/resources/views/frontend/home/achivements.blade.php ENDPATH**/ ?>