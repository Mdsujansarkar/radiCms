            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full lg:w-full my-6 pr-0 lg:pr-2">
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" action="<?php echo e(route('web.tag')); ?>"  method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mt-2">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oem/Documents/radiCms/resources/views/backend/seoPanel/metatag.blade.php ENDPATH**/ ?>