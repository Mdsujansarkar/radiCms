            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full lg:w-full my-6 pr-0 lg:pr-2">
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" action="<?php echo e(route('web.setting.update', $setting->id)); ?>" enctype="multipart/form-data"  method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mt-2">
                                ...
                                <input class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="title" name="site_title" type="text" value="<?php echo e($setting->site_title); ?>" aria-label="Web Site Title">
                            ...
                            <div class="mt-2">
                                ...
                                <input class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="site_tagline" name="site_tagline" type="text" value="<?php echo e($setting->site_tagline); ?>" aria-label="Web Site Tagline">
                                    ...
                                    <div class="m-4">
                                        ...
                                        <div class="flex items-center justify-center w-full">
                                            <label class="flex flex-col w-full h-32 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
                                                ...
                                                <img src="<?php echo e(asset('/backend/logo/'.$setting ->websit_logo)); ?>" width="80" height="80">
                                    ...
                                    <div class="m-4">
                                        ...
                                        <div class="flex items-center justify-center w-full">
                                            <label class="flex flex-col w-full h-32 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
                                                ...
                                                <img src="<?php echo e(asset('/backend/favicon/'.$setting ->web_sitfav)); ?>" width="60" height="60">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oem/Documents/radiCms/resources/views/backend/settings/settingEdit.blade.php ENDPATH**/ ?>