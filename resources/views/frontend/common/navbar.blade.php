  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg ">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="{{ URL::to('/') }}">দেলোয়ার হোসেন ফারুক<span class="color-b"></span></a>
     
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
		
          <li class="nav-item">
            <a class="nav-link" href="{{ URL::to('/') }}">মূলপাতা  </a>
          </li>
        <!--  <li class="nav-item">
            <a class="nav-link" href="about.html">সম্পর্কে</a>
          </li>-->
          <li class="nav-item">
            <a class="nav-link" href="{{ route('mycv') }}">জীবনবৃত্তান্ত</a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="{{ route('achivement') }}">কৃতিত্ব</a>
          </li>
		  
           <li class="nav-item">
            <a class="nav-link" href="{{ route('whatToDo') }}">কি করতে চাই </a>
          </li>
		   <li class="nav-item">
            <a class="nav-link" href="{{ route('howToDo') }}">কিভাবে করবো </a>
          </li>
		  <li class="nav-item">
            <a class="nav-link" href="{{ route('lastActivites') }}">লাকসাম-মনোহরগঞ্জ   </a>
          </li>
